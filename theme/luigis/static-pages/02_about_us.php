        ...
        <div class="container">
                ...
                <div class="row">
                        <div class="col-md-6"><img class="mb-30" src="<?php echo("http://$_SERVER[HTTP_HOST]"); ?>/wordpress/wp-content/themes/zippedTheme-1646243305971/images/about-1-600x400.jpg" alt=""></div>
                        <div class="col-md-6"><img class="mb-30" src="<?php echo("http://$_SERVER[HTTP_HOST]"); ?>/wordpress/wp-content/themes/zippedTheme-1646243305971/images/about-2-600x400.jpg" alt=""></div>
                        <div class="col-md-12">
        ...
        <div class="container">
                <div class="heading">
                        <img class="heading-img" src="<?php echo("http://$_SERVER[HTTP_HOST]"); ?>/wordpress/wp-content/themes/zippedTheme-1646243305971/images/heading_logo.png" alt="">
                        ...
                        <div class="swiper-wrapper pb-90 pb-sm-60 left-text center-sm-text">
                                <div class="swiper-slide">
                                        ...
                                        <p class="color-ash mb-50 mb-sm-30 mt-20">Etiam nec odio vestibulum est mattis
                                                ...
                                                vestibul. </p>
                                        <img class="circle-60 mb-20 " src="<?php echo("http://$_SERVER[HTTP_HOST]"); ?>/wordpress/wp-content/themes/zippedTheme-1646243305971/images/quoto-1-200x200.jpg" alt="">
                                ...
                                <div class="swiper-slide">
                                        ...
                                        <img class="circle-60 mb-20" src="<?php echo("http://$_SERVER[HTTP_HOST]"); ?>/wordpress/wp-content/themes/zippedTheme-1646243305971/images/quoto-2-200x200.jpg" alt="">
                                        <h6><b class="color-primary">Daiane Smith</b>,<b class="color-ash">Customer</b>
                                        </h6>
                                </div><!-- swiper-slide -->
                                ...
                                <div class="swiper-slide">
                                        ...
                                        <img class="circle-60 mb-20" src="<?php echo("http://$_SERVER[HTTP_HOST]"); ?>/wordpress/wp-content/themes/zippedTheme-1646243305971/images/quoto-3-200x200.jpg" alt="">
                                        <h6><b class="color-primary">Michael Williams</b>,<b class="color-ash">Customer</b></h6>
                                </div><!-- swiper-slide -->
...
</section><section class="counter-section section center-text" id="counter">
        <div class="container">
                <div class="row">
